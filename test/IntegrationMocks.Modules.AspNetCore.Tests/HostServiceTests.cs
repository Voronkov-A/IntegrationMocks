...
public sealed class HostServiceTests
{
    ...
    private class TestHostServiceContract
    {
        public TestHostServiceContract(int webApiPort)
        {
    ...
    private class TestHostService : HostService<TestHostServiceContract>
    {
        ...
        public TestHostService(IPortManager portManager, string healthPath, Range<int> portRange)
        {
            ...
            Contract = new TestHostServiceContract(_webApiPort.Number);
        }
        ...
        public override TestHostServiceContract Contract { get; }
